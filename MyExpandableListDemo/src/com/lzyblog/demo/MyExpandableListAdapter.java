...
public class MyExpandableListAdapter extends BaseExpandableListAdapter implements HeaderAdapter {
	...
	public MyExpandableListAdapter(Context context, MyExpandableListView listView, List<GroupInfo> groupData, List<List<String>> childData) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.friend_item_group, null);
		}
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.friend_item_child, null);
		}
